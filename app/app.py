...
seasons = pd.io.parquet.read_parquet(r'seasons.parquet',engine='pyarrow')
sdict = dict(zip(seasons.id,seasons.name)) ## Season Dictionary {id:name}

events = pd.io.parquet.read_parquet(r'events.parquet',engine='pyarrow')
...
matches = pq.read_parquet(r'vrc.parquet',engine='pyarrow')
stats = pq.read_parquet(r'stats.parquet',engine='pyarrow')
