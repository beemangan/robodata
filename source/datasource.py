...
events = "SELECT sku, name FROM events"
...
data = sqlio.read_sql_query(events,conn)
data = data.convert_dtypes() # Force conversion of datatypes, mainly alliance_color
print(data)
data.to_parquet(r'C:\Users\Brendan\Documents\Programming\Python Testing\robodata\source\parquet\events.parquet',engine='pyarrow')